...
- (void)startAnimation
{
    ...
    [JKPlayerViewMananger playerViewMananger].playerView.playControlView.playOrPauseBtn.alpha = 0.0f;
    _isAnimating = YES;
    self.alpha = 1.0f;
    self.anglePer = 0;
...
{
    [JKPlayerViewMananger playerViewMananger].playerView.playControlView.playOrPauseBtn.alpha = 1.0f;
